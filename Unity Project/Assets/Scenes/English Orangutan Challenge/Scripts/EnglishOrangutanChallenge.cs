...
{
    public class EnglishOrangutanChallenge : MonoBehaviour
    {
...
//            // Wait while tutorial is required or is in progress
        ...
        public IEnumerator EndRound(bool win)
        {
            ...
            sceneTransitioner.TransitionToScene("English Orangutan Challenge");
        }
        ...
        private void Start()
        {
            ...
            if (GameManager.Instance.CompletedEnglishChimpQuestions.Count == EnglishOrangutanQuestions.Questions.Count)
            {
                GameManager.Instance.CompletedEnglishChimpQuestions.Clear();
            }
            ...
            do
            {
                var randomQuestion = EnglishOrangutanQuestions.Questions[Random.Range(0, EnglishOrangutanQuestions.Questions.Count)];
